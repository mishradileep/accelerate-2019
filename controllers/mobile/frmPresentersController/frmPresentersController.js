define({
    ...
    onClickOfPresenter: function(presenter) {
        ...
        if (this.formId === "frmAgenda" || this.formId === "frmmyAgenda") {
            this.view.presenterDetail.isVisible = true;
          	this.view.presenterDetail.opacity = 1.0;
        } else {
            this.animatePresenterDetail(true);
        }
    },

    animatePresenterDetail: function(isVisible) {
        var self = this;
        let initialOpacity, finalOpacity;
        if (isVisible) {
            initialOpacity = 0.5;
            finalOpacity = 1.0;
            this.view.presenterDetail.opacity = 0;
	      	this.view.presenterDetail.isVisible = true;
        } else {
            initialOpacity = 0.5;
            finalOpacity = 0;
        ...
        this.view.presenterDetail.animate(
            kony.ui.createAnimation({
               100: {
                ...
                animationEnd: function() {
                  if(!isVisible){
                    self.view.presenterDetail.isVisible = false;
                  }
                }
            });
    },
    ...
    onClickOfCloseSpeakerDetails: function() {
		this.animatePresenterDetail(false);
    },
